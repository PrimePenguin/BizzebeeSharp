...
namespace BizzebeeSharp.Services.OrderExternalServices
{
    /// <summary>
    ///     A service for manipulating Bizzebee order external services.
    /// </summary>
    public class OrderExternalServices : BizzebeeService
    {
        /// <summary>
        ...
        public OrderExternalServices(string myBizzebeeUrl, string shopAccessToken) : base(myBizzebeeUrl, shopAccessToken)
        {
        }
