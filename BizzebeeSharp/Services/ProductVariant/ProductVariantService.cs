...
namespace BizzebeeSharp.Services.ProductVariant
{
    /// <summary>
    /// A service for manipulating Bizzebee variant variants.
    /// </summary>
    public class ProductVariantService : BizzebeeService
    {
        /// <summary>
        ...
        public ProductVariantService(string myBizzebeeUrl, string shopAccessToken) : base(myBizzebeeUrl, shopAccessToken) { }
