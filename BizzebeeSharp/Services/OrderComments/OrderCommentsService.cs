...
namespace BizzebeeSharp.Services.OrderComments
{
    /// <summary>
    ///     A service for manipulating Comments of order.
    /// </summary>
    public class OrderCommentsService : BizzebeeService
    {
        /// <summary>
        ...
        public OrderCommentsService(string myBizzebeeUrl, string shopAccessToken) : base(myBizzebeeUrl, shopAccessToken)
        {
        }
