...
namespace BizzebeeSharp.Services.Webhook
{
    /// <summary>
    /// A service for manipulating Bizzebee webhooks.
    /// </summary>
    public class WebhookService : BizzebeeService
    {
        /// <summary>
        ...
        public WebhookService(string myBizzebeeUrl, string shopAccessToken) : base(myBizzebeeUrl, shopAccessToken) { }
