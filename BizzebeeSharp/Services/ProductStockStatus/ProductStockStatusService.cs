...
namespace BizzebeeSharp.Services.ProductStockStatus
{
    /// <summary>
    /// A service for manipulating Bizzebee product stock statuses.
    /// </summary>
    public class ProductStockStatusService : BizzebeeService
    {
        /// <summary>
        ...
        public ProductStockStatusService(string myBizzebeeUrl, string shopAccessToken) : base(myBizzebeeUrl, shopAccessToken) { }
