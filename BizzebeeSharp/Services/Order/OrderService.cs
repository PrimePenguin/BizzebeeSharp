...
namespace BizzebeeSharp.Services.Order
{
    /// <summary>
    /// A service for manipulating Bizzebee orders.
    /// </summary>
    public class OrderService : BizzebeeService
    {
        /// <summary>
        ...
        public OrderService(string myBizzebeeUrl, string shopAccessToken) : base(myBizzebeeUrl, shopAccessToken) { }
