...
namespace BizzebeeSharp.Services.ProductVariantAttribute
{
    public class ProductVariantAttributeService : BizzebeeService
    {
        /// <summary>
        ...
        public ProductVariantAttributeService(string myBizzebeeUrl, string shopAccessToken) : base(myBizzebeeUrl,
            shopAccessToken)
        {
        }
