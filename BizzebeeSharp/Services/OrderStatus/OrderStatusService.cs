...
namespace BizzebeeSharp.Services.OrderStatus
{
    /// <summary>
    /// A service for manipulating Bizzebee order statuses.
    /// </summary>
    public class OrderStatusService : BizzebeeService
    {
        /// <summary>
        ...
        public OrderStatusService(string myBizzebeeUrl, string shopAccessToken) : base(myBizzebeeUrl, shopAccessToken) { }
