...
namespace BizzebeeSharp.Services.ProductBundledProductPrice
{
    public class ProductBundledProductPriceService : BizzebeeService
    {
        /// <summary>
        ...
        public ProductBundledProductPriceService(string myBizzebeeUrl, string shopAccessToken) : base(myBizzebeeUrl,
            shopAccessToken)
        {
        }
