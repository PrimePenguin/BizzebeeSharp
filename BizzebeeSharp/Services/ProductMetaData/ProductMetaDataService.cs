...
namespace BizzebeeSharp.Services.ProductMetaData
{
    public class ProductMetaDataService : BizzebeeService
    {
        /// <summary>
        ...
        public ProductMetaDataService(string myBizzebeeUrl, string shopAccessToken) : base(myBizzebeeUrl,
            shopAccessToken)
        {
        }
