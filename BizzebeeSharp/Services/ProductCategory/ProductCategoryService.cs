...
namespace BizzebeeSharp.Services.ProductCategory
{
    /// <summary>
    /// A service for manipulating Bizzebee product categories.
    /// </summary>
    public class ProductCategoryService : BizzebeeService
    {
        /// <summary>
        ...
        public ProductCategoryService(string myBizzebeeUrl, string shopAccessToken) : base(myBizzebeeUrl, shopAccessToken) { }
